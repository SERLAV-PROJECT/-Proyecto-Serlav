...
<head>
    ...
    <title>SERLAV</title>
    <meta name="description" content="Serlav - Sistema">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/cs-skin-elastic.css') }}" >
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="">Pa otra cosa</a></li>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <footer class="site-footer">
            <div class="footer-inner bg-white">
                <div class="row">
                    <div class="col-sm-6">
                        Hecho por &copy; 2022 Serlav
                    </div>
                    <div class="col-sm-6 text-right">
                        Designed by Serlav</a>
                    </div>
                </div>
            </div>
        </footer>
